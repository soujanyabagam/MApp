...
/**
 * Minimal Wavefront OBJ loader (positions + triangular faces). Normals optional; not used by [ObjRenderer].
 * Convention for dissector alignment: **longer leg along model +Y**, **shorter leg along model +X** (adjust export if needed).
 */
internal object ObjMeshLoader {
    ...
    data class Mesh(
        ...
        val vertexCount: Int,
        /** Half-extents of axis-aligned bounds in model space (after centering at origin). */
